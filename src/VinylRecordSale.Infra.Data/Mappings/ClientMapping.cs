...
namespace VinylRecordSale.Infra.Data.Mappings
{
    public class ClientMapping : IEntityTypeConfiguration<Client>
    {
        public void Configure(EntityTypeBuilder<Client> builder)
        {
            ...
            builder.Property(m => m.ClientId).HasColumnName("int").ValueGeneratedOnAdd();

            builder.Property(m => m.FullName).HasColumnName("varchar(100)").HasMaxLength(100).IsRequired();
            builder.Property(m => m.Email).HasColumnName("varchar(100)").HasMaxLength(100).IsRequired();
